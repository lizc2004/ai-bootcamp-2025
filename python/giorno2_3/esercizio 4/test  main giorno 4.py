...
directory.add_contact(Person(name="Margaret", surname="Hamilton", phone="01-234-567"))
directory.add_contact(Business(name="Vedrai", phone="+39-333-333333"))
directory.add_contact(Person(name="Linda", surname="Hamilton"))
